...
def configure_joltages(buttons: list[Wiring], joltages: list[int]) -> int:
    ...
    for free_var_values in product(*assignment_ranges):
        ...
        #print(f"Free var values {free_var_values}\nPresses {num_presses}")
...
class Solution():
    ...
    def solve(self, input_lines) -> tuple[int, int]:
...
sol = Solution()
with open("2025/inputs/day10/input.txt", "r") as f:
    print(sol.solve(f.readlines()))